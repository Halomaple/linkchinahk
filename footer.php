...
?>
		...
		<script src="<?php bloginfo('template_directory'); ?>/js/baidumap.js?version=<?php echo $GLOBALS['File_Version_Control']?>"></script>

		<script src="<?php bloginfo('template_directory'); ?>/js/server.js?version=<?php echo $GLOBALS['File_Version_Control']?>"></script>
		<script src="<?php bloginfo('template_directory'); ?>/js/footerUtils.js?version=<?php echo $GLOBALS['File_Version_Control']?>"></script>
	</body>
</html>
